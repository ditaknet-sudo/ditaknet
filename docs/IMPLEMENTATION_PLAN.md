...
- [x] Մաքուր pinned Python 3.11 environment-ում ամբողջ suite-ը՝ **220 passed,
...
- [x] Final source commit `80fc7f7ccbcdd96307caf5e63976ebae5e3ae736`-ի
  ...
  և actionlint-ը։
- [x] Final source commit-ը fast-forward push է արվել `main`։ Main CI
  [run #23](https://github.com/ditaknet-sudo/ditaknet/actions/runs/30075090079)
  ավարտվել է success՝ Python/security, exact amd64/arm64 image smoke,
  vulnerability gates և երկու SPDX SBOM-ներով։
- [x] Annotated `v2.0.2` tag-ը ստեղծվել և push է արվել միայն main CI-ի հաջող
  ավարտից հետո։ Release CI
  [run #24](https://github.com/ditaknet-sudo/ditaknet/actions/runs/30075677098)
  ավարտվել է success՝ բոլոր հինգ job-երով։
- [x] Public GitHub Release-ը, նրա `update-manifest.json` asset-ը և
  `update-feed/stable.json`-ը անկախ ներբեռնվել ու ստուգվել են։ Asset-ը և feed-ը
  byte-identical են՝ SHA-256
  `ab2db70aaa721f2087883f06988f6720f10da2603ee072ed767ba39991907a45`,
  իսկ Ed25519 ստորագրությունը վավեր է `stable-release-v1` key-ով։
- [x] Public GHCR `2.0.2` multi-arch index digest-ը
  `sha256:f649afda333a925ceaaa86177e398dd35fc21ab0b1c43b0744ebf405b0c71070`
  է։ Signed metadata-ի հետ համընկնում են նաև `linux/amd64`
  (`sha256:19a71dd2a2674c827f9d5fedcc73179fbe46281c18240d21b1a2883596dac079`)
  և `linux/arm64`
  (`sha256:9c0fde603bfc654fb331f1ae6fe5cca4016c28626ae6ae89de9becd3b4e37909`)
  digest-ները։
- [x] Հենց public `2.0.2` image-ը մեկուսացված tmpfs runtime-ով healthy է դարձել,
  default stable feed-ը ճանաչել է որպես `manifest_trusted=true`,
  `signing_key_id=stable-release-v1` և վերադարձրել է `status=up_to_date`։
  Temporary container-ը կանգնեցվել և ավտոմատ ջնջվել է։
- [x] Մեկուսացված legacy `2.0.1` + `2.0.2` feed փորձը վերադարձրել է
  `update_available=true`, `source_configured=true`,
  `auto_update_enabled=false`։ Նույն արդյունքը կրկնվել է արդեն public
  `stable.json` feed-ով։ Գործող legacy `2.0.1` instance-ը, սակայն, ստեղծված է
  առանց update URL-ի և այժմ վերադարձնում է `status=not_configured`,
  `source_configured=false`։ Այն չի կարող ինքնուրույն տեղադրել `2.0.2`։
  Առաջին անցումը one-time manual bootstrap է։ `2.0.2`-ից
