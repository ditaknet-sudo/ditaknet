...
- [ ] `linux/amd64` և `linux/arm64` multi-arch build։
- [~] Docker bridge compose runtime validation — definition-ը և static config validation-ը պատրաստ են։
- [~] TrueNAS host-network compose runtime validation — definition-ը և static config validation-ը պատրաստ են։
